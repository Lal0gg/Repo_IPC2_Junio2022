    ...
    for departamento in raiz1:
        for empleado in departamento:
            ...
            if(iddd == idactual):
                ...
                print('\t| ID: ', empleado.attrib['id'])
                print('\t| Nombre: ', empleado.findall(
                    'nombre')[0].text,  end="|")
                print('\t| Puesto: ', empleado.findall(
                    'puesto')[0].text,   end="|")
                print('\t| Salario: ', empleado.findall(
                    'salario')[0].text, end="|")
                print(
                    '\n\t|__________________________________________________________________________________|')
                return
...
def GraficarEmpleados(raiz1):
    ...
    for departamento in raiz1:
        ...
        contenido += NameNodoDep+"[label=\"" + \
            departamento.attrib['departamento']+"\"] \n"
        ...
        for empleado in departamento:
            ...
            contenido += NameNodoIdEmp + \
                "[label=\"Empleado: "+empleado.attrib['id']+"\"] \n"
    ...
    contenido += "}"
    if(os.path.exists("comandos/archivoEmp1.dot")):
        archivoDot = open("comandos/archivo2.dot", 'w', encoding="utf-8")
        archivoDot.write(contenido)
        archivoDot.close()
        comandoDot = "dot -Tjpg comandos/archivo2.dot -o reportes/reporteEmpleados2.jpg"
        check_output(comandoDot, shell=True)
        os.system(comandoDot)
    else:
        archivoDot = open("comandos/archivoEmp1.dot", 'w', encoding="utf-8")
        archivoDot.write(contenido)
        archivoDot.close()
        comandoDot = "dot -Tjpg comandos/archivoEmp1.dot -o reportes/reporteEmpleados1.jpg"
        check_output(comandoDot, shell=True)
        os.system(comandoDot)
...
def GraficarDiscos(raiz2):
    ...
    for cd in raiz2:
        ...
        contadorcd += 1
    contenido += "}"
    if(os.path.exists("comandos/archivoDiscos1.dot")):
        archivoDot = open("comandos/archivoDiscos2.dot", 'w', encoding="utf-8")
        archivoDot.write(contenido)
        archivoDot.close()
        comandoDot = "dot -Tjpg comandos/archivoDiscos2.dot -o reportes/reporteDiscos2.jpg"
        check_output(comandoDot, shell=True)
        os.system(comandoDot)
    else:
        archivoDot = open("comandos/archivoDiscos1.dot", 'w', encoding="utf-8")
        archivoDot.write(contenido)
        archivoDot.close()
        comandoDot = "dot -Tjpg comandos/archivoDiscos1.dot -o reportes/reporteDiscos1.jpg"
        check_output(comandoDot, shell=True)
        os.system(comandoDot)
